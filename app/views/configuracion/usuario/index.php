      ...
      <tr>
		...
		<? if ($row_SESSION['usuario_add'] == '1'){ ?>            
            ...
            <tr>
              ...
              <td align="right" class="Textonegro"><input name="button2" type="button" class="BotonRojo" id="button2" value="      [ Atrás ]      " onClick="javascript:window.location='../index.php'" /></td>
            </tr>
		<? } ?>			
            <tr>
			  ...
			  <table width="95%" border="1" cellpadding="2" cellspacing="2" bordercolor="#F8F8F8">
                ...
                <tr>
                  <td class="Negrita"><div align="center">No se encontrarón Usuarios </div></td>
                </tr>
              </table>
			  <? } ?>			  </td>
            </tr>
