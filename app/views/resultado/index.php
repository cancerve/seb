...
<body>
  ...
  <ul>
    <li><a href="#tabs-1">Resultado de Negocios</a></li>
  </ul>
  <form name="form1" id="form1" method="post" action="gestionar.php" enctype="multipart/form-data">
  <div id="tabs-1">
      ...
      <tr>
        <td bordercolor="#F8F8F8">
          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="Textonegro" bgcolor="#FFFFFF">
            <tr bgcolor="#CCCCCC">
              <td colspan="2" class="BlancoGris">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Seleccione el Evento al que desea Gestionar los Resultados de Negocios</td>
            </tr>
            <tr bgcolor="#CCCCCC">
            ...
            <tr valign="baseline">
              <td colspan="2" align="center"><input name="Enviar" type="submit" class="BotonRojo" id="Enviar" value="[ Enviar ]">
