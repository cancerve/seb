...
$RS = $objUsuario->buscarUsuario($objConexion,$_SESSION["AF_Usuario"]);
if ($objConexion->cantidadRegistros($RS)>0){

	$AF_Usuario 		= $objConexion->obtenerElemento($RS,0,'AF_Usuario');
        ...
        <td bordercolor="#F8F8F8">
          <table width="100%" border="0" cellpadding="2" cellspacing="2" class="Textonegro">
            ...
            <tr valign="baseline">
              ...
              <td width="73%" class="NegritaMayor">&nbsp;<?=$AF_Usuario?></td>
            </tr>
