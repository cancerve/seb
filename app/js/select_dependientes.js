...
listadoSelects[0]="pais_AL_CodPais";
listadoSelects[1]="ciudad_AF_CodCiudad";
...
function cargaContenido(idSelectOrigen,valor_ciudad)
{
	...
	else if(idSelectOrigen!=listadoSelects[listadoSelects.length-1])
	{
		...
		var ajax=nuevoAjax();
		ajax.open("GET", "http://localhost/seb/app/includes/select_dependientes.php?select="+idSelectDestino+"&opcion="+opcionSeleccionada+"&valor_ciudad="+valor_ciudad, true);
