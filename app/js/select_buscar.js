...
function load_Contactar_Empresa()
{
	...
	xmlhttp.open("POST","http://localhost/seb/app/includes/select_buscar.php",true);
...
//FUNCION PARA TRAER EMPRESAS POSTULADAS///////////
function load_Emp_Postu()
{
	var xmlhttp;
	var n=document.getElementById('AF_CodEvento').value;
	...
	xmlhttp.open("POST","http://localhost/seb/app/includes/select_buscar.php",true);
	xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	xmlhttp.send("Emp_Postu="+n);
}
//FUNCION PARA TRAER SOLICITUDES DE CITAS///////////
function load_Soli_Citas()
{
	var xmlhttp;
	var n=document.getElementById('AF_CodEvento').value;
